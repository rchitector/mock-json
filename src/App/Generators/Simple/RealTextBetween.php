...
class RealTextBetween extends BaseSimpleGenerator implements GeneratorInterface
{
    private $minNbChars = 160;
    ...
    {
        return $this->faker->realTextBetween(
            $this->minNbChars,
            $this->maxNbChars,
            $this->indexSize,
        );
    ...
    public function minNbChars($minNbChars): static
    {
        $this->minNbChars = $minNbChars;
        return $this;
    }
